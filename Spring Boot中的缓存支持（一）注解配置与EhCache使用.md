...
原创
 ...
 [2016-06-16](http://blog.didispace.com/springbootcache1/)
...
首先，下载样例工程[chapter3-2-2](https://git.oschina.net/didispace/SpringBoot-Learning)。本例通过spring-data-jpa实现了对User用户表的一些操作，若没有这个基础，可以先阅读[《使用Spring-data-jpa简化数据访问层》](http://blog.didispace.com/springbootdata2/)一文对数据访问有所基础。
...
完整示例：[Chapter-4-4-1](https://git.oschina.net/didispace/SpringBoot-Learning)
